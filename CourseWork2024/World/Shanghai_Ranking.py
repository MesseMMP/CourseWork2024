...
def switch_page(arg):
    ...
    switch_page = browser.find_element(By.XPATH, '//*[@id="content-box"]/div[2]/table/thead/tr/th[6]/div/div[1]/div[1]')
    switch_page.click()
...
for year in [2023, 2022, 2021, 2020, 2019]:
    ...
    for page in range(max_pages):
        ...
        for i in range(1, len(table_rows)):
            ...
            country = \
                info_page.find('div', class_='contact-msg').find_all('div', class_='contact-item')[1].find_all('span')[
                    1].text.strip()
    ...
    column_names = ['World Rank', 'Institution', 'Country', 'National Rank', 'Total Score', 'Alumni', 'Award', 'HiCi',
                    'N&S', 'PUB', 'PCP']
    ...
    df.to_excel(f'Data/World/Shanghai_Ranking_{str(year)}.xlsx', index=False)
